...
public class AddPreguntaActivity extends AppCompatActivity {
    ...
    private static final int REC_PREGUNTA = 100,REC_PUNTOS = 101, REC_ALT1=102
            ,REC_ALT2=103,REC_ALT3=104,REC_ALT4=105;

    EditText edtPregunta,edtPuntos,edtAlternativa1,edtAlternativa2,edtAlternativa3,edtAlternativa4;
    Button btnAgregar, btnRegresar;
    ImageButton btnPregunta,btnPuntos,btnAlternativa1,btnAlternativa2,btnAlternativa3,btnAlternativa4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtAlternativa4 = findViewById(R.id.edtAlternativa3);
    ...
    private void agregarPregunta() {
        ...
        if (pregunta.isEmpty()) {
            Toast.makeText(this, "Ingrese Pregunta", Toast.LENGTH_SHORT).show();
            return;

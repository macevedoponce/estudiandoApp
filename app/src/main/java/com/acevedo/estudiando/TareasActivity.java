...
public class TareasActivity extends AppCompatActivity {
    ...
    String url="http://192.168.1.46/android/m/index.php";
    Tareas tareas;
    ...
    private void EliminarDatos(String id){
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.1.7:8080/appMobileEstudiando/eliminar_tareas.php", new Response.Listener<String>() {
            @Override
